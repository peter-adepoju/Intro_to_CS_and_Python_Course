...
# b = 10*2 = 20        -> a=10, b=20
# a = 20-5 = 15         -> a=15, b=20
# b = 15+20 = 35         -> a=15, b=35
# Final values: 15 35

# Exercise 2:
fahrenheit_temp = 98.6
celsius_temp = (fahrenheit_temp - 32) * 5 / 9
print(f"{celsius_temp:.1f}")   # 37.0
...
gross_pay = 4500
tax_rate = 0.22
take_home_pay = gross_pay - (gross_pay * tax_rate)
print(take_home_pay)   # 3510.0

# Challenge:
x, y, z = 1, 2, 3
x, y, z = y, z, x   # right side fully evaluated first: (2, 3, 1)
print(x, y, z)       # 2 3 1
"""
