...
2. Click `day11_defining_functions.ipynb` to open Day 11's notebook.

You can also open notebooks from the terminal:
```bash
jupyter notebook "Intro-to-Python-Course/Week_03/02_NOTEBOOKS/day11_defining_functions.ipynb"
```
...
Go to: `00_SCHEDULE/week_03_schedule.md`
