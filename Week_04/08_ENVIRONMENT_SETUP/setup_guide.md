...
2. Click `day16_recursive_thinking.ipynb` to open Day 16's notebook.

You can also open notebooks from the terminal:
```bash
jupyter notebook "Intro-to-Python-Course/Week_04/02_NOTEBOOKS/day16_recursive_thinking.ipynb"
```
...
Go to: `00_SCHEDULE/week_04_schedule.md`
